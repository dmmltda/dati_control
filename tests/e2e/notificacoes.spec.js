 ...
 * ============================================================================
 * E2E — Notificações
 * tests/e2e/notificacoes.spec.js
 * ============================================================================
 */
import { test, expect } from './fixtures/base.js';

const BELL = 'button:has(> i.ph-bell), button:has(.ph-bell)';

test.describe('🔔 Notificações', () => {

    // Não precisa de beforeEach — autenticação via storageState (base.js)
    ...
    test('07 — Dropdown fecha ao pressionar Escape', async ({ page }) => {
        ...
        await expect(page.locator('#notif-dropdown')).not.toBeVisible({ timeout: 3000 });
    });
