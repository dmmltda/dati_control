...
function injetarCSS() {
  ...
  style.textContent = `
    ...
    /* ─── Dropdown de usuário (menu geral) ─── */
    .db-user-dropdown {
      position: relative;
      display: inline-flex;
    }
    ...
    .db-user-dropdown-menu.open {
      display: block;
      animation: db-dd-in 140ms ease;
    }
    @keyframes db-dd-in {
    ...
    .db-dropdown-item:hover { background: #F4F6F9; }
    ...
    /* Avatar inline no botão do dropdown */
    .db-user-btn {
      display: flex;
      align-items: center;
      gap: 0.5rem;
